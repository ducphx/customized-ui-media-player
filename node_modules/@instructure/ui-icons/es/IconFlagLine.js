...
class IconFlagLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconFlagLine.glyphName = 'flag';
IconFlagLine.variant = 'Line';
IconFlagLine.displayName = 'IconFlagLine';
IconFlagLine.propTypes = { ...SVGIcon.propTypes
};
IconFlagLine.allowedProps = [...SVGIcon.allowedProps];
