...
class IconTableSplitCellsSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTableSplitCellsSolid.glyphName = 'table-split-cells';
IconTableSplitCellsSolid.variant = 'Solid';
IconTableSplitCellsSolid.displayName = 'IconTableSplitCellsSolid';
IconTableSplitCellsSolid.propTypes = { ...SVGIcon.propTypes
};
IconTableSplitCellsSolid.allowedProps = [...SVGIcon.allowedProps];
