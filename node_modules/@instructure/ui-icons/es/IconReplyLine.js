...
class IconReplyLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconReplyLine.glyphName = 'reply';
IconReplyLine.variant = 'Line';
IconReplyLine.displayName = 'IconReplyLine';
IconReplyLine.propTypes = { ...SVGIcon.propTypes
};
IconReplyLine.allowedProps = [...SVGIcon.allowedProps];
