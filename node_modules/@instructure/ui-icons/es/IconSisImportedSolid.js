...
class IconSisImportedSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconSisImportedSolid.glyphName = 'sis-imported';
IconSisImportedSolid.variant = 'Solid';
IconSisImportedSolid.displayName = 'IconSisImportedSolid';
IconSisImportedSolid.propTypes = { ...SVGIcon.propTypes
};
IconSisImportedSolid.allowedProps = [...SVGIcon.allowedProps];
