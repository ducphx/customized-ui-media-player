...
class IconCopyCourseSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconCopyCourseSolid.glyphName = 'copy-course';
IconCopyCourseSolid.variant = 'Solid';
IconCopyCourseSolid.displayName = 'IconCopyCourseSolid';
IconCopyCourseSolid.deprecated = true;
IconCopyCourseSolid.propTypes = { ...SVGIcon.propTypes
};
IconCopyCourseSolid.allowedProps = [...SVGIcon.allowedProps];
