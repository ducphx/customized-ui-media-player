...
class IconBulletListAlphaLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconBulletListAlphaLine.propTypes = { ...SVGIcon.propTypes
};
IconBulletListAlphaLine.allowedProps = [...SVGIcon.allowedProps];
