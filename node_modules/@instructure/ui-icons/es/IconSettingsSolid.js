...
class IconSettingsSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconSettingsSolid.glyphName = 'settings';
IconSettingsSolid.variant = 'Solid';
IconSettingsSolid.displayName = 'IconSettingsSolid';
IconSettingsSolid.propTypes = { ...SVGIcon.propTypes
};
IconSettingsSolid.allowedProps = [...SVGIcon.allowedProps];
