...
class IconStudioLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconStudioLine.propTypes = { ...SVGIcon.propTypes
};
IconStudioLine.allowedProps = [...SVGIcon.allowedProps];
export default IconStudioLine;
export { IconStudioLine };