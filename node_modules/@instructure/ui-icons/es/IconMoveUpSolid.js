...
class IconMoveUpSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconMoveUpSolid.glyphName = 'move-up';
IconMoveUpSolid.variant = 'Solid';
IconMoveUpSolid.displayName = 'IconMoveUpSolid';
IconMoveUpSolid.propTypes = { ...SVGIcon.propTypes
};
IconMoveUpSolid.allowedProps = [...SVGIcon.allowedProps];
