...
class IconEquellaSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconEquellaSolid.propTypes = { ...SVGIcon.propTypes
};
IconEquellaSolid.allowedProps = [...SVGIcon.allowedProps];
export default IconEquellaSolid;
export { IconEquellaSolid };