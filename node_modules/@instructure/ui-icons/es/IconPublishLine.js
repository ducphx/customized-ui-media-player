...
class IconPublishLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconPublishLine.glyphName = 'publish';
IconPublishLine.variant = 'Line';
IconPublishLine.displayName = 'IconPublishLine';
IconPublishLine.propTypes = { ...SVGIcon.propTypes
};
IconPublishLine.allowedProps = [...SVGIcon.allowedProps];
