...
class IconAttachMediaSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconAttachMediaSolid.glyphName = 'attach-media';
IconAttachMediaSolid.variant = 'Solid';
IconAttachMediaSolid.displayName = 'IconAttachMediaSolid';
IconAttachMediaSolid.propTypes = { ...SVGIcon.propTypes
};
IconAttachMediaSolid.allowedProps = [...SVGIcon.allowedProps];
