...
class IconDeactivateUserLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconDeactivateUserLine.propTypes = { ...SVGIcon.propTypes
};
IconDeactivateUserLine.allowedProps = [...SVGIcon.allowedProps];
