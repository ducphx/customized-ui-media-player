...
class IconUnlockSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconUnlockSolid.glyphName = 'unlock';
IconUnlockSolid.variant = 'Solid';
IconUnlockSolid.displayName = 'IconUnlockSolid';
IconUnlockSolid.propTypes = { ...SVGIcon.propTypes
};
IconUnlockSolid.allowedProps = [...SVGIcon.allowedProps];
