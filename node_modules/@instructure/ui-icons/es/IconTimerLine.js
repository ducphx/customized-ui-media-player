...
class IconTimerLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTimerLine.glyphName = 'timer';
IconTimerLine.variant = 'Line';
IconTimerLine.displayName = 'IconTimerLine';
IconTimerLine.propTypes = { ...SVGIcon.propTypes
};
IconTimerLine.allowedProps = [...SVGIcon.allowedProps];
