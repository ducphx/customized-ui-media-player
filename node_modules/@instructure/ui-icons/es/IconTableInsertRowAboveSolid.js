...
class IconTableInsertRowAboveSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTableInsertRowAboveSolid.glyphName = 'table-insert-row-above';
IconTableInsertRowAboveSolid.variant = 'Solid';
IconTableInsertRowAboveSolid.displayName = 'IconTableInsertRowAboveSolid';
IconTableInsertRowAboveSolid.propTypes = { ...SVGIcon.propTypes
};
IconTableInsertRowAboveSolid.allowedProps = [...SVGIcon.allowedProps];
