...
class IconHomeLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconHomeLine.glyphName = 'home';
IconHomeLine.variant = 'Line';
IconHomeLine.displayName = 'IconHomeLine';
IconHomeLine.propTypes = { ...SVGIcon.propTypes
};
IconHomeLine.allowedProps = [...SVGIcon.allowedProps];
