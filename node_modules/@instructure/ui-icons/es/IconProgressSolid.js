...
class IconProgressSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconProgressSolid.glyphName = 'progress';
IconProgressSolid.variant = 'Solid';
IconProgressSolid.displayName = 'IconProgressSolid';
IconProgressSolid.propTypes = { ...SVGIcon.propTypes
};
IconProgressSolid.allowedProps = [...SVGIcon.allowedProps];
