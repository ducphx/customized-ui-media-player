...
class IconQuizStatsAvgLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconQuizStatsAvgLine.glyphName = 'quiz-stats-avg';
IconQuizStatsAvgLine.variant = 'Line';
IconQuizStatsAvgLine.displayName = 'IconQuizStatsAvgLine';
IconQuizStatsAvgLine.propTypes = { ...SVGIcon.propTypes
};
IconQuizStatsAvgLine.allowedProps = [...SVGIcon.allowedProps];
