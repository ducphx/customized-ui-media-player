...
class IconGradebookExportLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconGradebookExportLine.glyphName = 'gradebook-export';
IconGradebookExportLine.variant = 'Line';
IconGradebookExportLine.displayName = 'IconGradebookExportLine';
IconGradebookExportLine.propTypes = { ...SVGIcon.propTypes
};
IconGradebookExportLine.allowedProps = [...SVGIcon.allowedProps];
