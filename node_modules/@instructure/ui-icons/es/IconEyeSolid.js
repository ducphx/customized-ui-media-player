...
class IconEyeSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconEyeSolid.glyphName = 'eye';
IconEyeSolid.variant = 'Solid';
IconEyeSolid.displayName = 'IconEyeSolid';
IconEyeSolid.propTypes = { ...SVGIcon.propTypes
};
IconEyeSolid.allowedProps = [...SVGIcon.allowedProps];
