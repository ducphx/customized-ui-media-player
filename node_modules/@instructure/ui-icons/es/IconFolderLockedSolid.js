...
class IconFolderLockedSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconFolderLockedSolid.glyphName = 'folder-locked';
IconFolderLockedSolid.variant = 'Solid';
IconFolderLockedSolid.displayName = 'IconFolderLockedSolid';
IconFolderLockedSolid.propTypes = { ...SVGIcon.propTypes
};
IconFolderLockedSolid.allowedProps = [...SVGIcon.allowedProps];
