...
class IconLaunchLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconLaunchLine.glyphName = 'launch';
IconLaunchLine.variant = 'Line';
IconLaunchLine.displayName = 'IconLaunchLine';
IconLaunchLine.propTypes = { ...SVGIcon.propTypes
};
IconLaunchLine.allowedProps = [...SVGIcon.allowedProps];
