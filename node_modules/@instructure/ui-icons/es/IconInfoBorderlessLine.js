...
class IconInfoBorderlessLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconInfoBorderlessLine.propTypes = { ...SVGIcon.propTypes
};
IconInfoBorderlessLine.allowedProps = [...SVGIcon.allowedProps];
