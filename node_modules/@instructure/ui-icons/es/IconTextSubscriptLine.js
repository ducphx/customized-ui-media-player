...
class IconTextSubscriptLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTextSubscriptLine.glyphName = 'text-subscript';
IconTextSubscriptLine.variant = 'Line';
IconTextSubscriptLine.displayName = 'IconTextSubscriptLine';
IconTextSubscriptLine.propTypes = { ...SVGIcon.propTypes
};
IconTextSubscriptLine.allowedProps = [...SVGIcon.allowedProps];
