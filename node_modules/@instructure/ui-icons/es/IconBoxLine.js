...
class IconBoxLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconBoxLine.glyphName = 'box';
IconBoxLine.variant = 'Line';
IconBoxLine.displayName = 'IconBoxLine';
IconBoxLine.propTypes = { ...SVGIcon.propTypes
};
IconBoxLine.allowedProps = [...SVGIcon.allowedProps];
