...
class IconTableDeleteRowLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTableDeleteRowLine.glyphName = 'table-delete-row';
IconTableDeleteRowLine.variant = 'Line';
IconTableDeleteRowLine.displayName = 'IconTableDeleteRowLine';
IconTableDeleteRowLine.propTypes = { ...SVGIcon.propTypes
};
IconTableDeleteRowLine.allowedProps = [...SVGIcon.allowedProps];
