...
class IconZoomInSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconZoomInSolid.glyphName = 'zoom-in';
IconZoomInSolid.variant = 'Solid';
IconZoomInSolid.displayName = 'IconZoomInSolid';
IconZoomInSolid.propTypes = { ...SVGIcon.propTypes
};
IconZoomInSolid.allowedProps = [...SVGIcon.allowedProps];
