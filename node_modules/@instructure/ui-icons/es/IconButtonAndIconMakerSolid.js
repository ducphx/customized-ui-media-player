...
class IconButtonAndIconMakerSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconButtonAndIconMakerSolid.propTypes = { ...SVGIcon.propTypes
};
IconButtonAndIconMakerSolid.allowedProps = [...SVGIcon.allowedProps];
