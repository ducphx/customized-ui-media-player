...
class IconTableLeftHeaderSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTableLeftHeaderSolid.glyphName = 'table-left-header';
IconTableLeftHeaderSolid.variant = 'Solid';
IconTableLeftHeaderSolid.displayName = 'IconTableLeftHeaderSolid';
IconTableLeftHeaderSolid.propTypes = { ...SVGIcon.propTypes
};
IconTableLeftHeaderSolid.allowedProps = [...SVGIcon.allowedProps];
