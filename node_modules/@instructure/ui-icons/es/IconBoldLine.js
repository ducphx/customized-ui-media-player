...
class IconBoldLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconBoldLine.glyphName = 'bold';
IconBoldLine.variant = 'Line';
IconBoldLine.displayName = 'IconBoldLine';
IconBoldLine.propTypes = { ...SVGIcon.propTypes
};
IconBoldLine.allowedProps = [...SVGIcon.allowedProps];
