...
class IconDiscussionReplyLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconDiscussionReplyLine.glyphName = 'discussion-reply';
IconDiscussionReplyLine.variant = 'Line';
IconDiscussionReplyLine.displayName = 'IconDiscussionReplyLine';
IconDiscussionReplyLine.deprecated = true;
IconDiscussionReplyLine.propTypes = { ...SVGIcon.propTypes
};
IconDiscussionReplyLine.allowedProps = [...SVGIcon.allowedProps];
