...
class IconAddFolderLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconAddFolderLine.glyphName = 'add-folder';
IconAddFolderLine.variant = 'Line';
IconAddFolderLine.displayName = 'IconAddFolderLine';
IconAddFolderLine.propTypes = { ...SVGIcon.propTypes
};
IconAddFolderLine.allowedProps = [...SVGIcon.allowedProps];
