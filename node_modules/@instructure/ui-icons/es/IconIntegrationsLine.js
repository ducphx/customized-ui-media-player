...
class IconIntegrationsLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconIntegrationsLine.glyphName = 'integrations';
IconIntegrationsLine.variant = 'Line';
IconIntegrationsLine.displayName = 'IconIntegrationsLine';
IconIntegrationsLine.propTypes = { ...SVGIcon.propTypes
};
IconIntegrationsLine.allowedProps = [...SVGIcon.allowedProps];
