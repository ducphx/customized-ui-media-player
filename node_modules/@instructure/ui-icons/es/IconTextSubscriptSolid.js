...
class IconTextSubscriptSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTextSubscriptSolid.propTypes = { ...SVGIcon.propTypes
};
IconTextSubscriptSolid.allowedProps = [...SVGIcon.allowedProps];
