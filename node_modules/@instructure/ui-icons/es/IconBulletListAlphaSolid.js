...
class IconBulletListAlphaSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconBulletListAlphaSolid.propTypes = { ...SVGIcon.propTypes
};
IconBulletListAlphaSolid.allowedProps = [...SVGIcon.allowedProps];
