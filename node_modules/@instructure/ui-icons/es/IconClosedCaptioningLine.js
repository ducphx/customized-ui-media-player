...
class IconClosedCaptioningLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconClosedCaptioningLine.glyphName = 'closed-captioning';
IconClosedCaptioningLine.variant = 'Line';
IconClosedCaptioningLine.displayName = 'IconClosedCaptioningLine';
IconClosedCaptioningLine.propTypes = { ...SVGIcon.propTypes
};
IconClosedCaptioningLine.allowedProps = [...SVGIcon.allowedProps];
