...
class IconAudioOffLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconAudioOffLine.glyphName = 'audio-off';
IconAudioOffLine.variant = 'Line';
IconAudioOffLine.displayName = 'IconAudioOffLine';
IconAudioOffLine.propTypes = { ...SVGIcon.propTypes
};
IconAudioOffLine.allowedProps = [...SVGIcon.allowedProps];
