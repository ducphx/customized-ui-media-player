...
class IconImportantDatesSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconImportantDatesSolid.propTypes = { ...SVGIcon.propTypes
};
IconImportantDatesSolid.allowedProps = [...SVGIcon.allowedProps];
