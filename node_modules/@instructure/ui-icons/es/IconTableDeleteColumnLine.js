...
class IconTableDeleteColumnLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTableDeleteColumnLine.glyphName = 'table-delete-column';
IconTableDeleteColumnLine.variant = 'Line';
IconTableDeleteColumnLine.displayName = 'IconTableDeleteColumnLine';
IconTableDeleteColumnLine.propTypes = { ...SVGIcon.propTypes
};
IconTableDeleteColumnLine.allowedProps = [...SVGIcon.allowedProps];
