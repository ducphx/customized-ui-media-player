...
class IconEquellaLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconEquellaLine.propTypes = { ...SVGIcon.propTypes
};
IconEquellaLine.allowedProps = [...SVGIcon.allowedProps];
export default IconEquellaLine;
export { IconEquellaLine };