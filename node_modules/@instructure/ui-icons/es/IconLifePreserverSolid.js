...
class IconLifePreserverSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconLifePreserverSolid.propTypes = { ...SVGIcon.propTypes
};
IconLifePreserverSolid.allowedProps = [...SVGIcon.allowedProps];
