...
class IconHomeSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconHomeSolid.glyphName = 'home';
IconHomeSolid.variant = 'Solid';
IconHomeSolid.displayName = 'IconHomeSolid';
IconHomeSolid.propTypes = { ...SVGIcon.propTypes
};
IconHomeSolid.allowedProps = [...SVGIcon.allowedProps];
