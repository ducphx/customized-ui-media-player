...
class IconGradebookImportSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconGradebookImportSolid.propTypes = { ...SVGIcon.propTypes
};
IconGradebookImportSolid.allowedProps = [...SVGIcon.allowedProps];
