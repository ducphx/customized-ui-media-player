...
class IconCalendarReservedLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconCalendarReservedLine.glyphName = 'calendar-reserved';
IconCalendarReservedLine.variant = 'Line';
IconCalendarReservedLine.displayName = 'IconCalendarReservedLine';
IconCalendarReservedLine.propTypes = { ...SVGIcon.propTypes
};
IconCalendarReservedLine.allowedProps = [...SVGIcon.allowedProps];
