...
class IconToggleStartSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconToggleStartSolid.glyphName = 'toggle-start';
IconToggleStartSolid.variant = 'Solid';
IconToggleStartSolid.displayName = 'IconToggleStartSolid';
IconToggleStartSolid.propTypes = { ...SVGIcon.propTypes
};
IconToggleStartSolid.allowedProps = [...SVGIcon.allowedProps];
