...
class IconCheckPlusLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconCheckPlusLine.glyphName = 'check-plus';
IconCheckPlusLine.variant = 'Line';
IconCheckPlusLine.displayName = 'IconCheckPlusLine';
IconCheckPlusLine.propTypes = { ...SVGIcon.propTypes
};
IconCheckPlusLine.allowedProps = [...SVGIcon.allowedProps];
