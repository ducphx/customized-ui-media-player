...
class IconMediaLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconMediaLine.glyphName = 'media';
IconMediaLine.variant = 'Line';
IconMediaLine.displayName = 'IconMediaLine';
IconMediaLine.propTypes = { ...SVGIcon.propTypes
};
IconMediaLine.allowedProps = [...SVGIcon.allowedProps];
