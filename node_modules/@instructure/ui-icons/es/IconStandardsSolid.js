...
class IconStandardsSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconStandardsSolid.glyphName = 'standards';
IconStandardsSolid.variant = 'Solid';
IconStandardsSolid.displayName = 'IconStandardsSolid';
IconStandardsSolid.propTypes = { ...SVGIcon.propTypes
};
IconStandardsSolid.allowedProps = [...SVGIcon.allowedProps];
