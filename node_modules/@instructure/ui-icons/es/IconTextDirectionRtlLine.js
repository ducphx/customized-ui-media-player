...
class IconTextDirectionRtlLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTextDirectionRtlLine.glyphName = 'text-direction-rtl';
IconTextDirectionRtlLine.variant = 'Line';
IconTextDirectionRtlLine.displayName = 'IconTextDirectionRtlLine';
IconTextDirectionRtlLine.propTypes = { ...SVGIcon.propTypes
};
IconTextDirectionRtlLine.allowedProps = [...SVGIcon.allowedProps];
