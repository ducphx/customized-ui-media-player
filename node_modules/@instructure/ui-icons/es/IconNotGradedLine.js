...
class IconNotGradedLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconNotGradedLine.glyphName = 'not-graded';
IconNotGradedLine.variant = 'Line';
IconNotGradedLine.displayName = 'IconNotGradedLine';
IconNotGradedLine.propTypes = { ...SVGIcon.propTypes
};
IconNotGradedLine.allowedProps = [...SVGIcon.allowedProps];
