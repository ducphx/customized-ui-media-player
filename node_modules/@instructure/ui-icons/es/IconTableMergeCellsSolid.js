...
class IconTableMergeCellsSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTableMergeCellsSolid.glyphName = 'table-merge-cells';
IconTableMergeCellsSolid.variant = 'Solid';
IconTableMergeCellsSolid.displayName = 'IconTableMergeCellsSolid';
IconTableMergeCellsSolid.propTypes = { ...SVGIcon.propTypes
};
IconTableMergeCellsSolid.allowedProps = [...SVGIcon.allowedProps];
