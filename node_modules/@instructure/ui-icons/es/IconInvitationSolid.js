...
class IconInvitationSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconInvitationSolid.glyphName = 'invitation';
IconInvitationSolid.variant = 'Solid';
IconInvitationSolid.displayName = 'IconInvitationSolid';
IconInvitationSolid.propTypes = { ...SVGIcon.propTypes
};
IconInvitationSolid.allowedProps = [...SVGIcon.allowedProps];
