...
class IconAudioSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconAudioSolid.glyphName = 'audio';
IconAudioSolid.variant = 'Solid';
IconAudioSolid.displayName = 'IconAudioSolid';
IconAudioSolid.propTypes = { ...SVGIcon.propTypes
};
IconAudioSolid.allowedProps = [...SVGIcon.allowedProps];
