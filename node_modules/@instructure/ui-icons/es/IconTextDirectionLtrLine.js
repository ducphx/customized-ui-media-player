...
class IconTextDirectionLtrLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTextDirectionLtrLine.glyphName = 'text-direction-ltr';
IconTextDirectionLtrLine.variant = 'Line';
IconTextDirectionLtrLine.displayName = 'IconTextDirectionLtrLine';
IconTextDirectionLtrLine.propTypes = { ...SVGIcon.propTypes
};
IconTextDirectionLtrLine.allowedProps = [...SVGIcon.allowedProps];
