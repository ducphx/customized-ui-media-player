...
class IconBulletListSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconBulletListSolid.glyphName = 'bullet-list';
IconBulletListSolid.variant = 'Solid';
IconBulletListSolid.displayName = 'IconBulletListSolid';
IconBulletListSolid.propTypes = { ...SVGIcon.propTypes
};
IconBulletListSolid.allowedProps = [...SVGIcon.allowedProps];
