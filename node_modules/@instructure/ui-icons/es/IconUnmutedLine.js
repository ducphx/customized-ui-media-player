...
class IconUnmutedLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconUnmutedLine.glyphName = 'unmuted';
IconUnmutedLine.variant = 'Line';
IconUnmutedLine.displayName = 'IconUnmutedLine';
IconUnmutedLine.propTypes = { ...SVGIcon.propTypes
};
IconUnmutedLine.allowedProps = [...SVGIcon.allowedProps];
