...
class IconFilesCopyrightLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconFilesCopyrightLine.propTypes = { ...SVGIcon.propTypes
};
IconFilesCopyrightLine.allowedProps = [...SVGIcon.allowedProps];
