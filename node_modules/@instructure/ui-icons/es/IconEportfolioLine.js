...
class IconEportfolioLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconEportfolioLine.glyphName = 'eportfolio';
IconEportfolioLine.variant = 'Line';
IconEportfolioLine.displayName = 'IconEportfolioLine';
IconEportfolioLine.propTypes = { ...SVGIcon.propTypes
};
IconEportfolioLine.allowedProps = [...SVGIcon.allowedProps];
