...
class IconCheckPlusSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconCheckPlusSolid.glyphName = 'check-plus';
IconCheckPlusSolid.variant = 'Solid';
IconCheckPlusSolid.displayName = 'IconCheckPlusSolid';
IconCheckPlusSolid.propTypes = { ...SVGIcon.propTypes
};
IconCheckPlusSolid.allowedProps = [...SVGIcon.allowedProps];
