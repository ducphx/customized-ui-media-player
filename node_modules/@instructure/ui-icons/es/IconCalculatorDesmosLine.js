...
class IconCalculatorDesmosLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconCalculatorDesmosLine.propTypes = { ...SVGIcon.propTypes
};
IconCalculatorDesmosLine.allowedProps = [...SVGIcon.allowedProps];
export default IconCalculatorDesmosLine;
export { IconCalculatorDesmosLine };