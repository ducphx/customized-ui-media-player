...
class IconRulerLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconRulerLine.glyphName = 'ruler';
IconRulerLine.variant = 'Line';
IconRulerLine.displayName = 'IconRulerLine';
IconRulerLine.propTypes = { ...SVGIcon.propTypes
};
IconRulerLine.allowedProps = [...SVGIcon.allowedProps];
