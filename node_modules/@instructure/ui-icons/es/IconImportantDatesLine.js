...
class IconImportantDatesLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconImportantDatesLine.propTypes = { ...SVGIcon.propTypes
};
IconImportantDatesLine.allowedProps = [...SVGIcon.allowedProps];
