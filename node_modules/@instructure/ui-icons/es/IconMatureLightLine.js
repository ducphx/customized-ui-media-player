...
class IconMatureLightLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconMatureLightLine.glyphName = 'mature-light';
IconMatureLightLine.variant = 'Line';
IconMatureLightLine.displayName = 'IconMatureLightLine';
IconMatureLightLine.deprecated = true;
IconMatureLightLine.propTypes = { ...SVGIcon.propTypes
};
IconMatureLightLine.allowedProps = [...SVGIcon.allowedProps];
