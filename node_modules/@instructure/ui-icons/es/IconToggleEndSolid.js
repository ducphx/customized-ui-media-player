...
class IconToggleEndSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconToggleEndSolid.glyphName = 'toggle-end';
IconToggleEndSolid.variant = 'Solid';
IconToggleEndSolid.displayName = 'IconToggleEndSolid';
IconToggleEndSolid.propTypes = { ...SVGIcon.propTypes
};
IconToggleEndSolid.allowedProps = [...SVGIcon.allowedProps];
