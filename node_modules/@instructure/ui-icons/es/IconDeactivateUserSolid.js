...
class IconDeactivateUserSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconDeactivateUserSolid.propTypes = { ...SVGIcon.propTypes
};
IconDeactivateUserSolid.allowedProps = [...SVGIcon.allowedProps];
