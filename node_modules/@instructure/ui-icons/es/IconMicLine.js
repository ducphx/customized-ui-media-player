...
class IconMicLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconMicLine.glyphName = 'mic';
IconMicLine.variant = 'Line';
IconMicLine.displayName = 'IconMicLine';
IconMicLine.propTypes = { ...SVGIcon.propTypes
};
IconMicLine.allowedProps = [...SVGIcon.allowedProps];
