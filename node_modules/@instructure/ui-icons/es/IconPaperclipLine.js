...
class IconPaperclipLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconPaperclipLine.glyphName = 'paperclip';
IconPaperclipLine.variant = 'Line';
IconPaperclipLine.displayName = 'IconPaperclipLine';
IconPaperclipLine.propTypes = { ...SVGIcon.propTypes
};
IconPaperclipLine.allowedProps = [...SVGIcon.allowedProps];
