...
class IconImmersiveReaderLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconImmersiveReaderLine.propTypes = { ...SVGIcon.propTypes
};
IconImmersiveReaderLine.allowedProps = [...SVGIcon.allowedProps];
