...
class IconImmersiveReaderSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconImmersiveReaderSolid.propTypes = { ...SVGIcon.propTypes
};
IconImmersiveReaderSolid.allowedProps = [...SVGIcon.allowedProps];
