...
class IconSyllabusLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconSyllabusLine.glyphName = 'syllabus';
IconSyllabusLine.variant = 'Line';
IconSyllabusLine.displayName = 'IconSyllabusLine';
IconSyllabusLine.propTypes = { ...SVGIcon.propTypes
};
IconSyllabusLine.allowedProps = [...SVGIcon.allowedProps];
