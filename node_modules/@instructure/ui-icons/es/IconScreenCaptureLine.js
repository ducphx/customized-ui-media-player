...
class IconScreenCaptureLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconScreenCaptureLine.glyphName = 'screen-capture';
IconScreenCaptureLine.variant = 'Line';
IconScreenCaptureLine.displayName = 'IconScreenCaptureLine';
IconScreenCaptureLine.propTypes = { ...SVGIcon.propTypes
};
IconScreenCaptureLine.allowedProps = [...SVGIcon.allowedProps];
