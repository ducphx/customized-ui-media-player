...
class IconTableInsertColumnBeforeSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
  ...
  render() {
    return /*#__PURE__*/React.createElement(SVGIcon, Object.assign({}, this.props, {
      name: "IconTableInsertColumnBefore",
...
IconTableInsertColumnBeforeSolid.glyphName = 'table-insert-column-before';
IconTableInsertColumnBeforeSolid.variant = 'Solid';
IconTableInsertColumnBeforeSolid.displayName = 'IconTableInsertColumnBeforeSolid';
IconTableInsertColumnBeforeSolid.propTypes = { ...SVGIcon.propTypes
};
IconTableInsertColumnBeforeSolid.allowedProps = [...SVGIcon.allowedProps];
