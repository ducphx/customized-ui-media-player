...
class IconMaterialsRequiredLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconMaterialsRequiredLine.propTypes = { ...SVGIcon.propTypes
};
IconMaterialsRequiredLine.allowedProps = [...SVGIcon.allowedProps];
