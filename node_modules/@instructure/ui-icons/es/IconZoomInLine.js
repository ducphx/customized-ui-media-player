...
class IconZoomInLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconZoomInLine.glyphName = 'zoom-in';
IconZoomInLine.variant = 'Line';
IconZoomInLine.displayName = 'IconZoomInLine';
IconZoomInLine.propTypes = { ...SVGIcon.propTypes
};
IconZoomInLine.allowedProps = [...SVGIcon.allowedProps];
