...
class IconTableSplitCellsLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTableSplitCellsLine.propTypes = { ...SVGIcon.propTypes
};
IconTableSplitCellsLine.allowedProps = [...SVGIcon.allowedProps];
