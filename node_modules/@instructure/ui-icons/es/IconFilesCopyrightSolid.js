...
class IconFilesCopyrightSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconFilesCopyrightSolid.propTypes = { ...SVGIcon.propTypes
};
IconFilesCopyrightSolid.allowedProps = [...SVGIcon.allowedProps];
