...
class IconPartialLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconPartialLine.glyphName = 'partial';
IconPartialLine.variant = 'Line';
IconPartialLine.displayName = 'IconPartialLine';
IconPartialLine.propTypes = { ...SVGIcon.propTypes
};
IconPartialLine.allowedProps = [...SVGIcon.allowedProps];
