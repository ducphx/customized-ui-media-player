...
class IconBulletListCircleOutlineLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconBulletListCircleOutlineLine.glyphName = 'bullet-list-circle-outline';
IconBulletListCircleOutlineLine.variant = 'Line';
IconBulletListCircleOutlineLine.displayName = 'IconBulletListCircleOutlineLine';
IconBulletListCircleOutlineLine.propTypes = { ...SVGIcon.propTypes
};
IconBulletListCircleOutlineLine.allowedProps = [...SVGIcon.allowedProps];
