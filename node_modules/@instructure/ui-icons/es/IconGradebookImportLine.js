...
class IconGradebookImportLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconGradebookImportLine.glyphName = 'gradebook-import';
IconGradebookImportLine.variant = 'Line';
IconGradebookImportLine.displayName = 'IconGradebookImportLine';
IconGradebookImportLine.propTypes = { ...SVGIcon.propTypes
};
IconGradebookImportLine.allowedProps = [...SVGIcon.allowedProps];
