...
class IconToggleEndLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconToggleEndLine.glyphName = 'toggle-end';
IconToggleEndLine.variant = 'Line';
IconToggleEndLine.displayName = 'IconToggleEndLine';
IconToggleEndLine.propTypes = { ...SVGIcon.propTypes
};
IconToggleEndLine.allowedProps = [...SVGIcon.allowedProps];
