...
class IconLockSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconLockSolid.glyphName = 'lock';
IconLockSolid.variant = 'Solid';
IconLockSolid.displayName = 'IconLockSolid';
IconLockSolid.propTypes = { ...SVGIcon.propTypes
};
IconLockSolid.allowedProps = [...SVGIcon.allowedProps];
