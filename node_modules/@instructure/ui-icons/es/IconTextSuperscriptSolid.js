...
class IconTextSuperscriptSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconTextSuperscriptSolid.glyphName = 'text-superscript';
IconTextSuperscriptSolid.variant = 'Solid';
IconTextSuperscriptSolid.displayName = 'IconTextSuperscriptSolid';
IconTextSuperscriptSolid.propTypes = { ...SVGIcon.propTypes
};
IconTextSuperscriptSolid.allowedProps = [...SVGIcon.allowedProps];
