...
class IconScreenCaptureSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconScreenCaptureSolid.propTypes = { ...SVGIcon.propTypes
};
IconScreenCaptureSolid.allowedProps = [...SVGIcon.allowedProps];
