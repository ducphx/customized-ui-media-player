...
class IconRepliedLine extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconRepliedLine.glyphName = 'replied';
IconRepliedLine.variant = 'Line';
IconRepliedLine.displayName = 'IconRepliedLine';
IconRepliedLine.propTypes = { ...SVGIcon.propTypes
};
IconRepliedLine.allowedProps = [...SVGIcon.allowedProps];
