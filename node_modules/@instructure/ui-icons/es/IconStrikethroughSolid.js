...
class IconStrikethroughSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconStrikethroughSolid.propTypes = { ...SVGIcon.propTypes
};
IconStrikethroughSolid.allowedProps = [...SVGIcon.allowedProps];
