...
class IconCloudDownloadSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconCloudDownloadSolid.propTypes = { ...SVGIcon.propTypes
};
IconCloudDownloadSolid.allowedProps = [...SVGIcon.allowedProps];
