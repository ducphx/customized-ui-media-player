...
class IconRotateRightSolid extends Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconRotateRightSolid.glyphName = 'rotate-right';
IconRotateRightSolid.variant = 'Solid';
IconRotateRightSolid.displayName = 'IconRotateRightSolid';
IconRotateRightSolid.propTypes = { ...SVGIcon.propTypes
};
IconRotateRightSolid.allowedProps = [...SVGIcon.allowedProps];
