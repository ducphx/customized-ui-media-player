...
exports.default = exports.IconEndSolid = void 0;
...
class IconEndSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconEndSolid = IconEndSolid;
IconEndSolid.glyphName = 'end';
IconEndSolid.variant = 'Solid';
IconEndSolid.displayName = 'IconEndSolid';
IconEndSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconEndSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconEndSolid;
