...
exports.default = exports.IconMicSolid = void 0;
...
class IconMicSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconMicSolid = IconMicSolid;
IconMicSolid.glyphName = 'mic';
IconMicSolid.variant = 'Solid';
IconMicSolid.displayName = 'IconMicSolid';
IconMicSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconMicSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconMicSolid;
