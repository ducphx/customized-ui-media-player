...
exports.default = exports.IconToggleLeftSolid = void 0;
...
class IconToggleLeftSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
  ...
  render() {
    if (process.env.NODE_ENV !== 'production') {
      console.warn('<IconToggleLeftSolid /> is deprecated. Please use <IconToggleStartSolid /> instead.');
    }
...
exports.IconToggleLeftSolid = IconToggleLeftSolid;
IconToggleLeftSolid.glyphName = 'toggle-left';
IconToggleLeftSolid.variant = 'Solid';
IconToggleLeftSolid.displayName = 'IconToggleLeftSolid';
IconToggleLeftSolid.deprecated = true;
IconToggleLeftSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconToggleLeftSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconToggleLeftSolid;
