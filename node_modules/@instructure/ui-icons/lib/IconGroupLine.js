...
exports.default = exports.IconGroupLine = void 0;
...
class IconGroupLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconGroupLine = IconGroupLine;
IconGroupLine.glyphName = 'group';
IconGroupLine.variant = 'Line';
IconGroupLine.displayName = 'IconGroupLine';
IconGroupLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconGroupLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconGroupLine;
