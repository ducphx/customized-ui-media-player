...
exports.default = exports.IconTargetSolid = void 0;
...
class IconTargetSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconTargetSolid = IconTargetSolid;
IconTargetSolid.glyphName = 'target';
IconTargetSolid.variant = 'Solid';
IconTargetSolid.displayName = 'IconTargetSolid';
IconTargetSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTargetSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTargetSolid;
