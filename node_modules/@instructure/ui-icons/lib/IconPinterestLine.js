...
exports.default = exports.IconPinterestLine = void 0;
...
class IconPinterestLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPinterestLine = IconPinterestLine;
IconPinterestLine.glyphName = 'pinterest';
IconPinterestLine.variant = 'Line';
IconPinterestLine.displayName = 'IconPinterestLine';
IconPinterestLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPinterestLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPinterestLine;
