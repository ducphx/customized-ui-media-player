...
exports.default = exports.IconLtiLine = void 0;
...
class IconLtiLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconLtiLine = IconLtiLine;
IconLtiLine.glyphName = 'lti';
IconLtiLine.variant = 'Line';
IconLtiLine.displayName = 'IconLtiLine';
IconLtiLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconLtiLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconLtiLine;
