...
exports.default = exports.IconTableTopHeaderLine = void 0;
...
class IconTableTopHeaderLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconTableTopHeaderLine = IconTableTopHeaderLine;
IconTableTopHeaderLine.glyphName = 'table-top-header';
IconTableTopHeaderLine.variant = 'Line';
IconTableTopHeaderLine.displayName = 'IconTableTopHeaderLine';
IconTableTopHeaderLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTableTopHeaderLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTableTopHeaderLine;
