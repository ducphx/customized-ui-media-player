...
exports.default = exports.IconOutcomesLine = void 0;
...
class IconOutcomesLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconOutcomesLine = IconOutcomesLine;
IconOutcomesLine.glyphName = 'outcomes';
IconOutcomesLine.variant = 'Line';
IconOutcomesLine.displayName = 'IconOutcomesLine';
IconOutcomesLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconOutcomesLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconOutcomesLine;
