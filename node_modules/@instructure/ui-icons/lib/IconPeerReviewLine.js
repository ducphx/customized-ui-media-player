...
exports.default = exports.IconPeerReviewLine = void 0;
...
class IconPeerReviewLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPeerReviewLine = IconPeerReviewLine;
IconPeerReviewLine.glyphName = 'peer-review';
IconPeerReviewLine.variant = 'Line';
IconPeerReviewLine.displayName = 'IconPeerReviewLine';
IconPeerReviewLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPeerReviewLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPeerReviewLine;
