...
exports.default = exports.IconToggleRightSolid = void 0;
...
class IconToggleRightSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
  ...
  render() {
    if (process.env.NODE_ENV !== 'production') {
      console.warn('<IconToggleRightSolid /> is deprecated. Please use <IconToggleEndSolid /> instead.');
    }
...
exports.IconToggleRightSolid = IconToggleRightSolid;
IconToggleRightSolid.glyphName = 'toggle-right';
IconToggleRightSolid.variant = 'Solid';
IconToggleRightSolid.displayName = 'IconToggleRightSolid';
IconToggleRightSolid.deprecated = true;
IconToggleRightSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconToggleRightSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconToggleRightSolid;
