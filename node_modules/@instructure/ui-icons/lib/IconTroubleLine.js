...
exports.default = exports.IconTroubleLine = void 0;
...
class IconTroubleLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconTroubleLine = IconTroubleLine;
IconTroubleLine.glyphName = 'trouble';
IconTroubleLine.variant = 'Line';
IconTroubleLine.displayName = 'IconTroubleLine';
IconTroubleLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTroubleLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTroubleLine;
