...
exports.default = exports.IconTwitterLine = void 0;
...
class IconTwitterLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconTwitterLine = IconTwitterLine;
IconTwitterLine.glyphName = 'twitter';
IconTwitterLine.variant = 'Line';
IconTwitterLine.displayName = 'IconTwitterLine';
IconTwitterLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTwitterLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTwitterLine;
