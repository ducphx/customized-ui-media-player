...
exports.default = exports.IconStarLightSolid = void 0;
...
class IconStarLightSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconStarLightSolid = IconStarLightSolid;
IconStarLightSolid.glyphName = 'star-light';
IconStarLightSolid.variant = 'Solid';
IconStarLightSolid.displayName = 'IconStarLightSolid';
IconStarLightSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconStarLightSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconStarLightSolid;
