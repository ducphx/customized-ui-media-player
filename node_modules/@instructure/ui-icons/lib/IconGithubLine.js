...
exports.default = exports.IconGithubLine = void 0;
...
class IconGithubLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconGithubLine = IconGithubLine;
IconGithubLine.glyphName = 'github';
IconGithubLine.variant = 'Line';
IconGithubLine.displayName = 'IconGithubLine';
IconGithubLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconGithubLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconGithubLine;
