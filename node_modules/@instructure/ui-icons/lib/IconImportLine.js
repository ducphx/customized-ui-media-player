...
exports.default = exports.IconImportLine = void 0;
...
class IconImportLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconImportLine = IconImportLine;
IconImportLine.glyphName = 'import';
IconImportLine.variant = 'Line';
IconImportLine.displayName = 'IconImportLine';
IconImportLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconImportLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconImportLine;
