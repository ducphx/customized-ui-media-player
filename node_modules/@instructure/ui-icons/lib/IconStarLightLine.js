...
exports.default = exports.IconStarLightLine = void 0;
...
class IconStarLightLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconStarLightLine = IconStarLightLine;
IconStarLightLine.glyphName = 'star-light';
IconStarLightLine.variant = 'Line';
IconStarLightLine.displayName = 'IconStarLightLine';
IconStarLightLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconStarLightLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconStarLightLine;
