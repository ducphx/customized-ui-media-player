...
exports.default = exports.IconRemoveLinkLine = void 0;
...
class IconRemoveLinkLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconRemoveLinkLine = IconRemoveLinkLine;
IconRemoveLinkLine.glyphName = 'remove-link';
IconRemoveLinkLine.variant = 'Line';
IconRemoveLinkLine.displayName = 'IconRemoveLinkLine';
IconRemoveLinkLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconRemoveLinkLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconRemoveLinkLine;
