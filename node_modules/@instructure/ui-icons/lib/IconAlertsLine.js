...
exports.default = exports.IconAlertsLine = void 0;
...
class IconAlertsLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconAlertsLine = IconAlertsLine;
IconAlertsLine.glyphName = 'alerts';
IconAlertsLine.variant = 'Line';
IconAlertsLine.displayName = 'IconAlertsLine';
IconAlertsLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconAlertsLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconAlertsLine;
