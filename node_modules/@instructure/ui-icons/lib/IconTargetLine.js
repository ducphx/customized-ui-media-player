...
exports.default = exports.IconTargetLine = void 0;
...
class IconTargetLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconTargetLine = IconTargetLine;
IconTargetLine.glyphName = 'target';
IconTargetLine.variant = 'Line';
IconTargetLine.displayName = 'IconTargetLine';
IconTargetLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTargetLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTargetLine;
