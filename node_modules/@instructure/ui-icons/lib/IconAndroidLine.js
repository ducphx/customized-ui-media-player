...
exports.default = exports.IconAndroidLine = void 0;
...
class IconAndroidLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconAndroidLine = IconAndroidLine;
IconAndroidLine.glyphName = 'android';
IconAndroidLine.variant = 'Line';
IconAndroidLine.displayName = 'IconAndroidLine';
IconAndroidLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconAndroidLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconAndroidLine;
