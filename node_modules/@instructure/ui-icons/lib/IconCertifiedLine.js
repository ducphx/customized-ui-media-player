...
exports.default = exports.IconCertifiedLine = void 0;
...
class IconCertifiedLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconCertifiedLine = IconCertifiedLine;
IconCertifiedLine.glyphName = 'certified';
IconCertifiedLine.variant = 'Line';
IconCertifiedLine.displayName = 'IconCertifiedLine';
IconCertifiedLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconCertifiedLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconCertifiedLine;
