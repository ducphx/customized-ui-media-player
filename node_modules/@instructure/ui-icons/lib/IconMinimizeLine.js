...
exports.default = exports.IconMinimizeLine = void 0;
...
class IconMinimizeLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement(_SVGIcon.SVGIcon, Object.assign({}, this.props, {
      ...
      d: "M451.765 1016.47h1016.47V903.53H451.765z"
    }))));
  }

}

exports.IconMinimizeLine = IconMinimizeLine;
IconMinimizeLine.glyphName = 'minimize';
IconMinimizeLine.variant = 'Line';
IconMinimizeLine.displayName = 'IconMinimizeLine';
IconMinimizeLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconMinimizeLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconMinimizeLine;
