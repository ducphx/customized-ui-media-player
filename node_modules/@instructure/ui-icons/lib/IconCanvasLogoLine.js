...
exports.default = exports.IconCanvasLogoLine = void 0;
...
class IconCanvasLogoLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconCanvasLogoLine = IconCanvasLogoLine;
IconCanvasLogoLine.glyphName = 'canvas-logo';
IconCanvasLogoLine.variant = 'Line';
IconCanvasLogoLine.displayName = 'IconCanvasLogoLine';
IconCanvasLogoLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconCanvasLogoLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconCanvasLogoLine;
