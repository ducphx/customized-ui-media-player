...
exports.default = exports.IconEducatorsLine = void 0;
...
class IconEducatorsLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconEducatorsLine = IconEducatorsLine;
IconEducatorsLine.glyphName = 'educators';
IconEducatorsLine.variant = 'Line';
IconEducatorsLine.displayName = 'IconEducatorsLine';
IconEducatorsLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconEducatorsLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconEducatorsLine;
