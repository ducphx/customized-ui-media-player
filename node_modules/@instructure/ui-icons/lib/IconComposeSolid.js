...
exports.default = exports.IconComposeSolid = void 0;
...
class IconComposeSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconComposeSolid = IconComposeSolid;
IconComposeSolid.glyphName = 'compose';
IconComposeSolid.variant = 'Solid';
IconComposeSolid.displayName = 'IconComposeSolid';
IconComposeSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconComposeSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconComposeSolid;
