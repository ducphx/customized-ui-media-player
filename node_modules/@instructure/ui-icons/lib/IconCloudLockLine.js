...
exports.default = exports.IconCloudLockLine = void 0;
...
class IconCloudLockLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconCloudLockLine = IconCloudLockLine;
IconCloudLockLine.glyphName = 'cloud-lock';
IconCloudLockLine.variant = 'Line';
IconCloudLockLine.displayName = 'IconCloudLockLine';
IconCloudLockLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconCloudLockLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconCloudLockLine;
