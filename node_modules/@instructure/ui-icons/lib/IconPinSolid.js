...
exports.default = exports.IconPinSolid = void 0;
...
class IconPinSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPinSolid = IconPinSolid;
IconPinSolid.glyphName = 'pin';
IconPinSolid.variant = 'Solid';
IconPinSolid.displayName = 'IconPinSolid';
IconPinSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPinSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPinSolid;
