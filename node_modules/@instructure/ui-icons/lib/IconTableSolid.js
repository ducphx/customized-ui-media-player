...
exports.default = exports.IconTableSolid = void 0;
...
class IconTableSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconTableSolid = IconTableSolid;
IconTableSolid.glyphName = 'table';
IconTableSolid.variant = 'Solid';
IconTableSolid.displayName = 'IconTableSolid';
IconTableSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTableSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTableSolid;
