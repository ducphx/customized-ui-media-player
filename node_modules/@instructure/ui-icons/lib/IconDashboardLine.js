...
exports.default = exports.IconDashboardLine = void 0;
...
class IconDashboardLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconDashboardLine = IconDashboardLine;
IconDashboardLine.glyphName = 'dashboard';
IconDashboardLine.variant = 'Line';
IconDashboardLine.displayName = 'IconDashboardLine';
IconDashboardLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconDashboardLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconDashboardLine;
