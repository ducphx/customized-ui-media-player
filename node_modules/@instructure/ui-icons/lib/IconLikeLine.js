...
exports.default = exports.IconLikeLine = void 0;
...
class IconLikeLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconLikeLine = IconLikeLine;
IconLikeLine.glyphName = 'like';
IconLikeLine.variant = 'Line';
IconLikeLine.displayName = 'IconLikeLine';
IconLikeLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconLikeLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconLikeLine;
