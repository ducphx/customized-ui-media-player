...
exports.default = exports.IconStrikethroughLine = void 0;
...
class IconStrikethroughLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconStrikethroughLine = IconStrikethroughLine;
IconStrikethroughLine.glyphName = 'strikethrough';
IconStrikethroughLine.variant = 'Line';
IconStrikethroughLine.displayName = 'IconStrikethroughLine';
IconStrikethroughLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconStrikethroughLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconStrikethroughLine;
