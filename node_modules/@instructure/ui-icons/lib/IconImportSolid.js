...
exports.default = exports.IconImportSolid = void 0;
...
class IconImportSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconImportSolid = IconImportSolid;
IconImportSolid.glyphName = 'import';
IconImportSolid.variant = 'Solid';
IconImportSolid.displayName = 'IconImportSolid';
IconImportSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconImportSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconImportSolid;
