...
exports.default = exports.IconSkypeLine = void 0;
...
class IconSkypeLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconSkypeLine = IconSkypeLine;
IconSkypeLine.glyphName = 'skype';
IconSkypeLine.variant = 'Line';
IconSkypeLine.displayName = 'IconSkypeLine';
IconSkypeLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconSkypeLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconSkypeLine;
