...
exports.default = exports.IconStudioLine = void 0;
...
class IconStudioLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconStudioLine = IconStudioLine;
IconStudioLine.glyphName = 'studio';
IconStudioLine.variant = 'Line';
IconStudioLine.displayName = 'IconStudioLine';
IconStudioLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconStudioLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconStudioLine;
