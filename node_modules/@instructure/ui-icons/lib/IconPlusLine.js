...
exports.default = exports.IconPlusLine = void 0;
...
class IconPlusLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPlusLine = IconPlusLine;
IconPlusLine.glyphName = 'plus';
IconPlusLine.variant = 'Line';
IconPlusLine.displayName = 'IconPlusLine';
IconPlusLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPlusLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPlusLine;
