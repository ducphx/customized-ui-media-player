...
exports.default = exports.IconPostToSisSolid = void 0;
...
class IconPostToSisSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPostToSisSolid = IconPostToSisSolid;
IconPostToSisSolid.glyphName = 'post-to-sis';
IconPostToSisSolid.variant = 'Solid';
IconPostToSisSolid.displayName = 'IconPostToSisSolid';
IconPostToSisSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPostToSisSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPostToSisSolid;
