...
exports.default = exports.IconWarningLine = void 0;
...
class IconWarningLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconWarningLine = IconWarningLine;
IconWarningLine.glyphName = 'warning';
IconWarningLine.variant = 'Line';
IconWarningLine.displayName = 'IconWarningLine';
IconWarningLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconWarningLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconWarningLine;
