...
exports.default = exports.IconMatureLine = void 0;
...
class IconMatureLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconMatureLine = IconMatureLine;
IconMatureLine.glyphName = 'mature';
IconMatureLine.variant = 'Line';
IconMatureLine.displayName = 'IconMatureLine';
IconMatureLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconMatureLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconMatureLine;
