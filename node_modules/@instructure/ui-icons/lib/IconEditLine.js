...
exports.default = exports.IconEditLine = void 0;
...
class IconEditLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconEditLine = IconEditLine;
IconEditLine.glyphName = 'edit';
IconEditLine.variant = 'Line';
IconEditLine.displayName = 'IconEditLine';
IconEditLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconEditLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconEditLine;
