...
exports.default = exports.IconArcLine = void 0;
...
class IconArcLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconArcLine = IconArcLine;
IconArcLine.glyphName = 'Arc';
IconArcLine.variant = 'Line';
IconArcLine.displayName = 'IconArcLine';
IconArcLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconArcLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconArcLine;
