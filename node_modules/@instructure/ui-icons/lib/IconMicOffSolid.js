...
exports.default = exports.IconMicOffSolid = void 0;
...
class IconMicOffSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconMicOffSolid = IconMicOffSolid;
IconMicOffSolid.glyphName = 'mic-off';
IconMicOffSolid.variant = 'Solid';
IconMicOffSolid.displayName = 'IconMicOffSolid';
IconMicOffSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconMicOffSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconMicOffSolid;
