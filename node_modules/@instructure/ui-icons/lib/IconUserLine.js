...
exports.default = exports.IconUserLine = void 0;
...
class IconUserLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconUserLine = IconUserLine;
IconUserLine.glyphName = 'user';
IconUserLine.variant = 'Line';
IconUserLine.displayName = 'IconUserLine';
IconUserLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconUserLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconUserLine;
