...
exports.default = exports.IconAdminSolid = void 0;
...
class IconAdminSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconAdminSolid = IconAdminSolid;
IconAdminSolid.glyphName = 'admin';
IconAdminSolid.variant = 'Solid';
IconAdminSolid.displayName = 'IconAdminSolid';
IconAdminSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconAdminSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconAdminSolid;
