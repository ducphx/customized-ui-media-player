...
exports.default = exports.IconBankLine = void 0;
...
class IconBankLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconBankLine = IconBankLine;
IconBankLine.glyphName = 'bank';
IconBankLine.variant = 'Line';
IconBankLine.displayName = 'IconBankLine';
IconBankLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconBankLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconBankLine;
