...
exports.default = exports.IconRubricLine = void 0;
...
class IconRubricLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconRubricLine = IconRubricLine;
IconRubricLine.glyphName = 'rubric';
IconRubricLine.variant = 'Line';
IconRubricLine.displayName = 'IconRubricLine';
IconRubricLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconRubricLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconRubricLine;
