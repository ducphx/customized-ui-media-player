...
exports.default = exports.IconMicOffLine = void 0;
...
class IconMicOffLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconMicOffLine = IconMicOffLine;
IconMicOffLine.glyphName = 'mic-off';
IconMicOffLine.variant = 'Line';
IconMicOffLine.displayName = 'IconMicOffLine';
IconMicOffLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconMicOffLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconMicOffLine;
