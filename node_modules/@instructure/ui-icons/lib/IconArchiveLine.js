...
exports.default = exports.IconArchiveLine = void 0;
...
class IconArchiveLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconArchiveLine = IconArchiveLine;
IconArchiveLine.glyphName = 'archive';
IconArchiveLine.variant = 'Line';
IconArchiveLine.displayName = 'IconArchiveLine';
IconArchiveLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconArchiveLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconArchiveLine;
