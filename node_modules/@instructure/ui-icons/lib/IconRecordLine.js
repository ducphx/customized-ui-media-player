...
exports.default = exports.IconRecordLine = void 0;
...
class IconRecordLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconRecordLine = IconRecordLine;
IconRecordLine.glyphName = 'record';
IconRecordLine.variant = 'Line';
IconRecordLine.displayName = 'IconRecordLine';
IconRecordLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconRecordLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconRecordLine;
