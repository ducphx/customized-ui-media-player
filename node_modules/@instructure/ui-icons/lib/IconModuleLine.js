...
exports.default = exports.IconModuleLine = void 0;
...
class IconModuleLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconModuleLine = IconModuleLine;
IconModuleLine.glyphName = 'module';
IconModuleLine.variant = 'Line';
IconModuleLine.displayName = 'IconModuleLine';
IconModuleLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconModuleLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconModuleLine;
