...
exports.default = exports.IconHeartLine = void 0;
...
class IconHeartLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconHeartLine.glyphName = 'heart';
IconHeartLine.variant = 'Line';
IconHeartLine.displayName = 'IconHeartLine';
IconHeartLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconHeartLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconHeartLine;
