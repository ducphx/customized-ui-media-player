...
exports.default = exports.IconPaintLine = void 0;
...
class IconPaintLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPaintLine = IconPaintLine;
IconPaintLine.glyphName = 'paint';
IconPaintLine.variant = 'Line';
IconPaintLine.displayName = 'IconPaintLine';
IconPaintLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPaintLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPaintLine;
