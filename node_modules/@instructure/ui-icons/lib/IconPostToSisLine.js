...
exports.default = exports.IconPostToSisLine = void 0;
...
class IconPostToSisLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPostToSisLine = IconPostToSisLine;
IconPostToSisLine.glyphName = 'post-to-sis';
IconPostToSisLine.variant = 'Line';
IconPostToSisLine.displayName = 'IconPostToSisLine';
IconPostToSisLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPostToSisLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPostToSisLine;
