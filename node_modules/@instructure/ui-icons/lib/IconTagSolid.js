...
exports.default = exports.IconTagSolid = void 0;
...
class IconTagSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconTagSolid = IconTagSolid;
IconTagSolid.glyphName = 'tag';
IconTagSolid.variant = 'Solid';
IconTagSolid.displayName = 'IconTagSolid';
IconTagSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTagSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTagSolid;
