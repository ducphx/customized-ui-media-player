...
exports.default = exports.IconNoteDarkLine = void 0;
...
class IconNoteDarkLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconNoteDarkLine = IconNoteDarkLine;
IconNoteDarkLine.glyphName = 'note-dark';
IconNoteDarkLine.variant = 'Line';
IconNoteDarkLine.displayName = 'IconNoteDarkLine';
IconNoteDarkLine.deprecated = true;
IconNoteDarkLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconNoteDarkLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconNoteDarkLine;
