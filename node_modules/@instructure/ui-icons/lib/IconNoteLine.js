...
exports.default = exports.IconNoteLine = void 0;
...
class IconNoteLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconNoteLine = IconNoteLine;
IconNoteLine.glyphName = 'note';
IconNoteLine.variant = 'Line';
IconNoteLine.displayName = 'IconNoteLine';
IconNoteLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconNoteLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconNoteLine;
