...
exports.default = exports.IconPinLine = void 0;
...
class IconPinLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPinLine = IconPinLine;
IconPinLine.glyphName = 'pin';
IconPinLine.variant = 'Line';
IconPinLine.displayName = 'IconPinLine';
IconPinLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPinLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPinLine;
