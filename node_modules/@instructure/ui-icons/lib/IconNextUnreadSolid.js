...
exports.default = exports.IconNextUnreadSolid = void 0;
...
class IconNextUnreadSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconNextUnreadSolid = IconNextUnreadSolid;
IconNextUnreadSolid.glyphName = 'next-unread';
IconNextUnreadSolid.variant = 'Solid';
IconNextUnreadSolid.displayName = 'IconNextUnreadSolid';
IconNextUnreadSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconNextUnreadSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconNextUnreadSolid;
