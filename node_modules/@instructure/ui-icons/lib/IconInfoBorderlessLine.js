...
exports.default = exports.IconInfoBorderlessLine = void 0;
...
class IconInfoBorderlessLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconInfoBorderlessLine = IconInfoBorderlessLine;
IconInfoBorderlessLine.glyphName = 'info-borderless';
IconInfoBorderlessLine.variant = 'Line';
IconInfoBorderlessLine.displayName = 'IconInfoBorderlessLine';
IconInfoBorderlessLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconInfoBorderlessLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconInfoBorderlessLine;
