...
exports.default = exports.IconLinkLine = void 0;
...
class IconLinkLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconLinkLine = IconLinkLine;
IconLinkLine.glyphName = 'link';
IconLinkLine.variant = 'Line';
IconLinkLine.displayName = 'IconLinkLine';
IconLinkLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconLinkLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconLinkLine;
