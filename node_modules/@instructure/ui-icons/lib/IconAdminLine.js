...
exports.default = exports.IconAdminLine = void 0;
...
class IconAdminLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconAdminLine = IconAdminLine;
IconAdminLine.glyphName = 'admin';
IconAdminLine.variant = 'Line';
IconAdminLine.displayName = 'IconAdminLine';
IconAdminLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconAdminLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconAdminLine;
