...
exports.default = exports.IconPdfLine = void 0;
...
class IconPdfLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPdfLine = IconPdfLine;
IconPdfLine.glyphName = 'pdf';
IconPdfLine.variant = 'Line';
IconPdfLine.displayName = 'IconPdfLine';
IconPdfLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPdfLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPdfLine;
