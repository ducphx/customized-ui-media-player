...
exports.default = exports.IconUserSolid = void 0;
...
class IconUserSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconUserSolid.glyphName = 'user';
IconUserSolid.variant = 'Solid';
IconUserSolid.displayName = 'IconUserSolid';
IconUserSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconUserSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconUserSolid;
