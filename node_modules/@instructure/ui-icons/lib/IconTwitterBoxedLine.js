...
exports.default = exports.IconTwitterBoxedLine = void 0;
...
class IconTwitterBoxedLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
  ...
  render() {
    if (process.env.NODE_ENV !== 'production') {
      console.warn('<IconTwitterBoxedLine /> is deprecated. Please use <IconTwitterLine /> instead.');
    }
...
exports.IconTwitterBoxedLine = IconTwitterBoxedLine;
IconTwitterBoxedLine.glyphName = 'twitter-boxed';
IconTwitterBoxedLine.variant = 'Line';
IconTwitterBoxedLine.displayName = 'IconTwitterBoxedLine';
IconTwitterBoxedLine.deprecated = true;
IconTwitterBoxedLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTwitterBoxedLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTwitterBoxedLine;
