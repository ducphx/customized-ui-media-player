...
exports.default = exports.IconPdfSolid = void 0;
...
class IconPdfSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconPdfSolid = IconPdfSolid;
IconPdfSolid.glyphName = 'pdf';
IconPdfSolid.variant = 'Solid';
IconPdfSolid.displayName = 'IconPdfSolid';
IconPdfSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconPdfSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconPdfSolid;
