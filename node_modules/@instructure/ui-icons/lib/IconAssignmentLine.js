...
exports.default = exports.IconAssignmentLine = void 0;
...
class IconAssignmentLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconAssignmentLine = IconAssignmentLine;
IconAssignmentLine.glyphName = 'assignment';
IconAssignmentLine.variant = 'Line';
IconAssignmentLine.displayName = 'IconAssignmentLine';
IconAssignmentLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconAssignmentLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconAssignmentLine;
