...
exports.default = exports.IconInfoSolid = void 0;
...
class IconInfoSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconInfoSolid = IconInfoSolid;
IconInfoSolid.glyphName = 'info';
IconInfoSolid.variant = 'Solid';
IconInfoSolid.displayName = 'IconInfoSolid';
IconInfoSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconInfoSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconInfoSolid;
