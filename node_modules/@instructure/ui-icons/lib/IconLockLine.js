...
exports.default = exports.IconLockLine = void 0;
...
class IconLockLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconLockLine = IconLockLine;
IconLockLine.glyphName = 'lock';
IconLockLine.variant = 'Line';
IconLockLine.displayName = 'IconLockLine';
IconLockLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconLockLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconLockLine;
