...
exports.default = exports.IconExpandLine = void 0;
...
class IconExpandLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconExpandLine.glyphName = 'expand';
IconExpandLine.variant = 'Line';
IconExpandLine.displayName = 'IconExpandLine';
IconExpandLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconExpandLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconExpandLine;
