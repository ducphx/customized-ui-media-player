...
exports.default = exports.IconAdminToolsLine = void 0;
...
class IconAdminToolsLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconAdminToolsLine = IconAdminToolsLine;
IconAdminToolsLine.glyphName = 'admin-tools';
IconAdminToolsLine.variant = 'Line';
IconAdminToolsLine.displayName = 'IconAdminToolsLine';
IconAdminToolsLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconAdminToolsLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconAdminToolsLine;
