...
exports.default = exports.IconRssLine = void 0;
...
class IconRssLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconRssLine = IconRssLine;
IconRssLine.glyphName = 'rss';
IconRssLine.variant = 'Line';
IconRssLine.displayName = 'IconRssLine';
IconRssLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconRssLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconRssLine;
