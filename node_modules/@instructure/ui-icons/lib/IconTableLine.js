...
exports.default = exports.IconTableLine = void 0;
...
class IconTableLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconTableLine = IconTableLine;
IconTableLine.glyphName = 'table';
IconTableLine.variant = 'Line';
IconTableLine.displayName = 'IconTableLine';
IconTableLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTableLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTableLine;
