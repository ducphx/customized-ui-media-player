...
exports.default = exports.IconStarLine = void 0;
...
class IconStarLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconStarLine.glyphName = 'star';
IconStarLine.variant = 'Line';
IconStarLine.displayName = 'IconStarLine';
IconStarLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconStarLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconStarLine;
