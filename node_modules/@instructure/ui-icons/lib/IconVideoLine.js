...
exports.default = exports.IconVideoLine = void 0;
...
class IconVideoLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconVideoLine = IconVideoLine;
IconVideoLine.glyphName = 'video';
IconVideoLine.variant = 'Line';
IconVideoLine.displayName = 'IconVideoLine';
IconVideoLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconVideoLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconVideoLine;
