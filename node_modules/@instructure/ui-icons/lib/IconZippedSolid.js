...
exports.default = exports.IconZippedSolid = void 0;
...
class IconZippedSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconZippedSolid = IconZippedSolid;
IconZippedSolid.glyphName = 'zipped';
IconZippedSolid.variant = 'Solid';
IconZippedSolid.displayName = 'IconZippedSolid';
IconZippedSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconZippedSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconZippedSolid;
