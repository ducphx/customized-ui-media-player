...
exports.default = exports.IconAddressBookLine = void 0;
...
class IconAddressBookLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconAddressBookLine = IconAddressBookLine;
IconAddressBookLine.glyphName = 'address-book';
IconAddressBookLine.variant = 'Line';
IconAddressBookLine.displayName = 'IconAddressBookLine';
IconAddressBookLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconAddressBookLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconAddressBookLine;
