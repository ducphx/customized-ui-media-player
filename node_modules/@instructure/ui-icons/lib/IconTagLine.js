...
exports.default = exports.IconTagLine = void 0;
...
class IconTagLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconTagLine = IconTagLine;
IconTagLine.glyphName = 'tag';
IconTagLine.variant = 'Line';
IconTagLine.displayName = 'IconTagLine';
IconTagLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconTagLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconTagLine;
