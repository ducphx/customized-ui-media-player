...
exports.default = exports.IconMutedLine = void 0;
...
class IconMutedLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconMutedLine = IconMutedLine;
IconMutedLine.glyphName = 'muted';
IconMutedLine.variant = 'Line';
IconMutedLine.displayName = 'IconMutedLine';
IconMutedLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconMutedLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconMutedLine;
