...
exports.default = exports.IconArrowLeftLine = void 0;
...
class IconArrowLeftLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconArrowLeftLine.glyphName = 'arrow-left';
IconArrowLeftLine.variant = 'Line';
IconArrowLeftLine.displayName = 'IconArrowLeftLine';
IconArrowLeftLine.deprecated = true;
IconArrowLeftLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconArrowLeftLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconArrowLeftLine;
