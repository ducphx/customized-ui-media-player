...
exports.default = exports.IconQuizSolid = void 0;
...
class IconQuizSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconQuizSolid = IconQuizSolid;
IconQuizSolid.glyphName = 'quiz';
IconQuizSolid.variant = 'Solid';
IconQuizSolid.displayName = 'IconQuizSolid';
IconQuizSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconQuizSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconQuizSolid;
