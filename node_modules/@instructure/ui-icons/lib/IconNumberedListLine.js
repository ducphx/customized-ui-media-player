...
exports.default = exports.IconNumberedListLine = void 0;
...
class IconNumberedListLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconNumberedListLine = IconNumberedListLine;
IconNumberedListLine.glyphName = 'numbered-list';
IconNumberedListLine.variant = 'Line';
IconNumberedListLine.displayName = 'IconNumberedListLine';
IconNumberedListLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconNumberedListLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconNumberedListLine;
