...
exports.default = exports.IconGroupSolid = void 0;
...
class IconGroupSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconGroupSolid = IconGroupSolid;
IconGroupSolid.glyphName = 'group';
IconGroupSolid.variant = 'Solid';
IconGroupSolid.displayName = 'IconGroupSolid';
IconGroupSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconGroupSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconGroupSolid;
