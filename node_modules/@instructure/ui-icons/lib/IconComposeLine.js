...
exports.default = exports.IconComposeLine = void 0;
...
class IconComposeLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconComposeLine = IconComposeLine;
IconComposeLine.glyphName = 'compose';
IconComposeLine.variant = 'Line';
IconComposeLine.displayName = 'IconComposeLine';
IconComposeLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconComposeLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconComposeLine;
