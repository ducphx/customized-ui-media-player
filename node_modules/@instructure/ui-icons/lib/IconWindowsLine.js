...
exports.default = exports.IconWindowsLine = void 0;
...
class IconWindowsLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconWindowsLine = IconWindowsLine;
IconWindowsLine.glyphName = 'windows';
IconWindowsLine.variant = 'Line';
IconWindowsLine.displayName = 'IconWindowsLine';
IconWindowsLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconWindowsLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconWindowsLine;
