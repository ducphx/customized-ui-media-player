...
exports.default = exports.IconNoLine = void 0;
...
class IconNoLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconNoLine = IconNoLine;
IconNoLine.glyphName = 'no';
IconNoLine.variant = 'Line';
IconNoLine.displayName = 'IconNoLine';
IconNoLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconNoLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconNoLine;
