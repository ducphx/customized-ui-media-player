...
exports.default = exports.IconSearchSolid = void 0;
...
class IconSearchSolid extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
exports.IconSearchSolid = IconSearchSolid;
IconSearchSolid.glyphName = 'search';
IconSearchSolid.variant = 'Solid';
IconSearchSolid.displayName = 'IconSearchSolid';
IconSearchSolid.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconSearchSolid.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconSearchSolid;
