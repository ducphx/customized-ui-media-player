...
exports.default = exports.IconOffLine = void 0;
...
class IconOffLine extends _react.Component {
  constructor() {
    super(...arguments);
    this.ref = null;
...
IconOffLine.glyphName = 'off';
IconOffLine.variant = 'Line';
IconOffLine.displayName = 'IconOffLine';
IconOffLine.propTypes = { ..._SVGIcon.SVGIcon.propTypes
};
IconOffLine.allowedProps = [..._SVGIcon.SVGIcon.allowedProps];
var _default = IconOffLine;
