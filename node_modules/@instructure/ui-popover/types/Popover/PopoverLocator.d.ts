...
export declare const customMethods: {
    ...
    findPositionTarget: (...args: any[]) => any;
    findTrigger: (...args: any[]) => Promise<{
...
export declare const PopoverLocator: {
    customMethods: {
        findContent: (...args: any[]) => any;
        findPositionTarget: (...args: any[]) => any;
        findTrigger: (...args: any[]) => Promise<{
...
} & Record<"findContent" | "findPositionTarget" | "findTrigger", (...args: import("@instructure/ui-test-queries/src/utils/parseQueryArguments").QueryArguments) => Promise<unknown>>;
//# sourceMappingURL=PopoverLocator.d.ts.map